    ...
    describe 'create method' do
      ...
      it 'should pass SimpleQS::Queue instance to block' do
		...
		it 'should have name' do
			queue = SimpleQS::Queue.new 'http://queue.amazonaws.com/770098461991/testQueue'
			queue.name.should == 'testQueue'
		end

		it 'should be valid when created by name' do
			queue = SimpleQS::Queue.new 'testQueue'
			queue.queue_url.should == "http://queue.amazonaws.com/#{SimpleQS.account_id}/testQueue"
		end
